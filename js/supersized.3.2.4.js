		...
		base.resizeNow = function(){
			...
			return base.$el.each(function() {
		  		...
		  		$('img', base.el).each(function(){
					...
					// MORTEN: For these two I swapped width and height
					
					var browserheight = base.$el.width(),
						browserwidth = base.$el.height(),
						offset;
					...
					/// MORTEN: For these two I swapped browserheight and browserwidth


					// Horizontally Center
					if (base.options.horizontal_center){
						 $(this).css('left', (browserheight - $(this).width())/2);
					}
					
					// Vertically Center
					if (base.options.vertical_center){
						 $(this).css('top', (browserwidth - $(this).height())/2);
					}
